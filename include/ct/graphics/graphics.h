...
#include <ct\graphics\graphicsbase.h>
...
namespace CT
{
	...
	class CT_GFX_API GraphicsRenderTarget
	{
	private:
	...
	class CT_GFX_API GraphicsBuffer
	{
	private:
	...
	class CT_GFX_API EffectFactory
	{
	private:
	...
	class CT_GFX_API EffectResource
	{
	protected:
	...
	class CT_GFX_API GraphicsQueue
	{
	private:
	...
	class CT_GFX_API Texture : public EffectResource
	{
	private:
	...
	class CT_GFX_API TextureCube : public EffectResource
	{
	private:
