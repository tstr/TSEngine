...
#include <CT\gfx\graphicsmodel.h>
#include <CT\gfx\graphicstext.h>
#include <CT\filesystem\filecore.h>
#include <CT\filesystem\filexml.h>
...
/*
#include <CT\Core.h>
#include <CT\Core\typedefs.h>
#include <CT\Core\threading.h>
#include <CT\Core\LinearAlgebra.h>
#include <CT\Graphics\ABI\core.h>
#include <CT\Graphics\GfxCommon.h>
#include <CT\Graphics\Gfx.h>
#include <CT\Graphics\GfxModel.h>
#include <CT\FileSystem\xml.h>
#include <CT\FileSystem\xmlIterators.h>
...
int WINAPI WinMain(HMODULE Module, HMODULE prevModule, LPSTR cmdline, int showcmd)
{
	...
	*/
	...
	//system(((string)"E:\\programming\\c++\\CT\\bin\\x64\\Debug\\ModelParser.exe " + s).c_str());
	...
	//CT_ASSERT(FileSystem::FileExists("effectdefs.cfxd"));
	//EffectFactory fxFactory(g_renderer.get());
	//CT_ASSERT(fxFactory.CompileEffect("effectdefs.cfxd"));
	...
	*/
	...
	while (g_enabled)
	{
		...
		if (frame_time_average > frame_step)
		{
			...
			buf << "CTApp.exe - Frametime: " << 1000 * frame_time_average / (double)frame_count << "ms"
